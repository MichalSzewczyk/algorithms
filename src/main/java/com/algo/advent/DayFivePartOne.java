...
public class DayFivePartOne {
    public static void main(String[] args) {
        ...
        String[] cleaned = longInput.replaceAll(".+:\n", "").replaceAll("seeds: ", "").split("\n");
        long[][] mappings = new long[cleaned.length][];
        for (int idx = 0; idx < cleaned.length; idx++) {
            String[] numbers = cleaned[idx].split(" ");
            long[] parsedNumbers = Arrays.stream(numbers).mapToLong(value -> "".equals(value) ? -1L : Long.parseLong(value)).toArray();
